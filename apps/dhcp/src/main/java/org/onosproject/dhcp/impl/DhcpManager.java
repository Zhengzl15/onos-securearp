...
public class DhcpManager implements DhcpService {
   ...
   // @Reference(cardinality = ReferenceCardinality.MANDATORY_UNARY)
    //protected SecureArpService arpService;
    ...
    private static Ip4Address myIP = Ip4Address.valueOf("10.0.0.254");

    private static MacAddress myMAC = valueOf("4f:4f:4f:4f:4f:4f");
    
    private final static String freeIp = "10.0.0.";
    private int allocatedNum = 10;
